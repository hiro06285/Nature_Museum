module NotificationsHelper
  def notification_form(notification)
    ...
    @comment = nil
    your_item = link_to 'あなたの投稿', new_post_image_path(notification), style:"font-weight: bold;"
    ...
    case notification.action
      ...
      when "like" then
        tag.a(notification.visiter.name, href:user_path(@visiter), style:"font-weight: bold;")+"が"+tag.a('あなたの投稿', href:users_item_path(notification.item_id), style:"font-weight: bold;")+"にいいねしました"
      when "comment" then
